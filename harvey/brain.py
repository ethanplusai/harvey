...
class Brain:
    ...
    def load_skills_for_agent(self, agent_name: str) -> str:
        ...
        """
        # product_knowledge is auto-generated by the trainer
        # and loaded by every agent that needs product context
        skill_map = {
            "scout": ["prospecting_tactics", "lead_qualification", "product_knowledge"],
            "writer": ["email_frameworks", "sales_methodology", "product_knowledge"],
            "handler": ["objection_handling", "sales_methodology", "product_knowledge"],
